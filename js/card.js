...
(function () {
  ...
  window.card = {
    ...
    renderCardFragment: function (addOffer) {
      ...
      fragment.appendChild(window.card.renderCard(addOffer));
...
// cardListElement.insertBefore(window.card.renderCardFragment(window.data.dataValues[0]), mapFiltersContainer);
